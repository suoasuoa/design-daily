...
CATEGORY_SOURCE_GROUPS = {
    ...
    "T恤": ["design_community", "editorial_main", "market_signal_strong", "market_signal_weak"],
    "卫衣": ["design_community", "editorial_main", "market_signal_strong", "market_signal_weak"],
    "Polo衫": ["design_community", "editorial_main", "market_signal_strong", "market_signal_weak"],
    "帽子": ["design_community", "editorial_main", "market_signal_strong", "market_signal_weak"],
    ...
    "收纳包": ["editorial_main", "award_gallery", "design_community", "market_signal_strong", "market_signal_weak"],
}

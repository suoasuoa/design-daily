...
5. 宁可严格删除，也不要保留弱相关产品。
6. 对小红书、抖音、Instagram 等社媒来源，可以保留热度高、好看、有趣、种草、概念性、DIY/手作/改造类内容，但必须能看出明确物件、明确功能、明确使用场景，或对包装/结构/功能/外观有可转化启发。
7. 社媒来源不要求已经量产，也不要求一定能立即购买；概念产品、DIY 原型、手作改造可以保留，并优先归为“方向参考”或“适合改造”的候选。
8. 如果只是生活记录、娱乐视频、纯穿搭展示、无明确物件的教程、合集、话题页、用户页、搜索页，keep=false。

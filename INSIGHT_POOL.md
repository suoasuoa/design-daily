...
DeepSeek 请求受北京时间硬门禁保护，只能在官方空闲时段 `00:00-08:59`、`12:01-13:59` 和 `18:01-23:59` 发起。高峰期手动运行会停止 AI 请求，避免意外消耗；如需查看当次调用与 token 统计，可在 GitHub Actions 的 `DeepSeek usage` 摘要中查看。

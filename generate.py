...
# Pinterest (43 items)
PINTEREST = [
    ("Pinterest · 潮玩手机壳", "手机壳", "原创潮玩风个性化手机壳", "https://www.casetify.com/category/impact-cases", "", 300),
    ("Pinterest · 永生花礼盒", "创意礼盒", "永生花玻璃罩礼盒套装", "https://www.thebeastshop.com/", "", 500),
    ("Pinterest · Joseph Joseph砧板", "创意厨具", "Joseph Joseph分类菜板，卫生设计", "https://www.josephjoseph.com/products/chopping-boards", "", 2500),
    ("Pinterest · 折叠运动水壶", "钥匙扣水壶", "可折叠硅胶运动水壶", "https://nalgene.com/product/32oz-wide-mouth-sustain/", "", 200),
    ("Pinterest 包装设计灵感", "创意礼盒", "全球包装设计创意集锦", "https://www.pinterest.com/categories/packaging/", "", 509),
    ("Pinterest · stojo折叠随行杯", "水杯", "stojo可折叠硅胶随行杯，环保便携", "https://stojo.com/collections/cups", "", 1200),
    ("Pinterest · New Era经典59FIFTY", "帽子", "New Era 59FIFTY经典棒球帽", "https://www.neweracap.com/collections/59fifty-fitted", "", 400),
    ("Pinterest · 手工编织帽", "帽子", "手工天然稻草编织遮阳帽", "https://www.etsy.com/market/handmade_straw_hat", "", 1000),
    ("Pinterest · 中秋茶礼包装", "中秋礼盒", "中式风格中秋茶礼盒包装", "https://www.bamatea.com/", "", 300),
    ("Pinterest · 端午礼盒包装", "端午礼盒", "新中式端午礼盒包装设计", "https://www.wufangzhai.com/", "", 300),
    ("Pinterest · RFID防护卡包", "卡包", "RFID防射频极薄卡片包", "https://www.secrid.com/en/products/cardprotector", "", 350),
    ("Pinterest · 极简桌面日历", "日历", "PAPIER PLATZ极简桌面日历", "https://www.papierplatz.com/", "", 300),
    ("Pinterest · 茶仓分离杯", "水杯", "可分离茶仓设计的随行茶杯", "https://www.joinmunki.com/", "", 500),
    ("Pinterest · 模块化收纳盒", "收纳包", "MUJI PP模块化收纳盒系统", "https://www.muji.com/jp/ja/store/cmdty/section/S107010101", "", 300),
    ("Pinterest · Crewneck卫衣设计", "卫衣", "经典圆领卫衣宽松版型设计", "https://www.uniqlo.com/us/en/c/crewneck-sweatshirts/", "", 300),
    ("Pinterest · 盲盒收纳展示盒", "创意礼盒", "盲盒亚克力展示收纳盒", "https://www.popmart.com/", "", 400),
    ("Pinterest · 光影装置", "装置艺术", "LED光影互动艺术装置", "https://www.teamlab.art/", "", 5000),
    ("Pinterest 极简家居灵感", "创意礼盒", "极简北欧家居设计灵感集", "https://www.pinterest.com/categories/home/", "", 1696),
    ("Pinterest · 方形清酒杯", "水杯", "日本传统方形清酒杯，职人手作", "https://www.yoshidajpn.com/", "", 300),
    ("Pinterest · 实木显示器架", "创意桌搭", "北美黑胡桃木实木显示器架", "https://grovemade.com/shop/desk-accessories/", "", 2500),
    ("Pinterest · 月饼礼盒设计", "中秋礼盒", "轻奢风月饼礼盒包装设计", "https://www.maxims.com.hk/", "", 500),
    ("Pinterest · 真皮卡包", "卡包", "手工植鞣牛皮极简卡包", "https://bellroy.com/products/slim-sleeve-wallet", "", 500),
    ("Pinterest · 蘑菇氛围灯", "氛围灯", "可爱蘑菇造型小夜灯", "https://www.artemide.com/en/products/table/nessino", "", 2000),
    ("Pinterest · 极简笔筒", "创意桌搭", "Moshi极简胡桃木笔筒", "https://www.moshi.com/en/category/office", "", 400),
    ("Pinterest · 镜面装置", "装置艺术", "镜面不锈钢反射装置艺术", "https://www.anishkapoor.com/", "", 8000),
    ("Pinterest · 复古充电宝", "充电宝", "复古游戏机造型充电宝", "https://www.sharge.com/products/retro-67", "", 400),
    ("Pinterest · 翻页日历", "日历", "MUJI经典翻页桌面日历", "https://www.muji.com/jp/ja/store/cmdty/section/S107030204", "", 200),
    ("Pinterest · stojo折叠水壶", "水杯", "stojo可折叠便携运动水壶", "https://stojo.com/collections/bottles", "", 900),
    ("Pinterest · 磁吸锅铲套装", "创意厨具", "磁吸收纳锅铲套装", "https://www.peugeot-saveurs.com/", "", 400),
    ("Pinterest · 桌面线材收纳", "创意桌搭", "磁吸式桌面线材收纳管理器", "https://nomadgoods.com/collections/cables", "", 500),
    ("Pinterest · 极简Logo Tee", "T恤", "A.P.C.经典极简Logo白T恤", "https://www.apc.fr/categories/men/t-shirts", "", 600),
    ("Pinterest · 超薄充电宝", "充电宝", "Anker超薄磁吸充电宝", "https://www.anker.com/collections/chargers", "", 350),
    ("Pinterest · 旋转保温杯", "水杯", "OWALA旋转保温杯，单手开合设计", "https://www.owalalife.com/", "", 650),
    ("Pinterest · 硅胶折叠量杯", "创意厨具", "可折叠硅胶量杯", "https://www.oxo.com/kitchen-tools/measuring-cups", "", 600),
    ("Pinterest · 日落投影灯", "氛围灯", "智能日落渐变投影氛围灯", "https://nanoleaf.com/en-US/products/nanoleaf-aurora/", "", 3000),
    ("Pinterest · 极简纸灯", "氛围灯", "日本和纸极简落地灯", "https://www.muji.com/jp/ja/store/cmdty/section/S106010102", "", 1800),
    ("Pinterest · 刺绣Polo衫", "Polo衫", "Sunspel经典英国制Polo衫", "https://www.sunspel.com/en-us/polo-shirts.html", "", 1200),
    ("Pinterest · OXO沙拉甩干器", "创意厨具", "OXO Good Grips沙拉脱水器", "https://www.oxo.com/kitchen-tools/salad-spinners", "", 800),
    ("Pinterest · 香薰蜡烛礼盒", "创意礼盒", "极简无火香薰蜡烛礼盒", "https://www.diptyqueparis.com/en/candles/", "", 800),
    ("Pinterest · 巧克力礼盒装", "创意礼盒", "精品松露巧克力礼盒", "https://www.laderach.com/en/chocolate-gifts", "", 600),
    ("Pinterest · Fellow卡特杯", "水杯", "Fellow卡特陶瓷咖啡杯，极简设计", "https://fellowproducts.com/products/carter-mug", "", 800),
    ("Pinterest · 星星投影灯", "氛围灯", "卧室星空投影氛围灯", "https://www.twinkly.com/", "", 1500),
    ("Pinterest · 极简弯檐帽", "帽子", "无印良品极简弯檐棒球帽", "https://www.muji.com/jp/ja/store/cmdty/section/S105010101", "", 200),
]

# Behance (23 items)
BEHANCE = [
    ("Behance UI/UX 精选合集", "创意礼盒", "Behance全球精选UI/UX设计案例", "https://www.behance.net/galleries/ui-ux", "", 2436),
    ("Behance · 厨房好物设计", "创意厨具", "人性化厨房用具产品设计项目", "https://www.behance.net/search/projects/?search=kitchen+utensil+design", "", 500),
    ("Behance · 手机壳图案系列", "手机壳", "原创插画手机壳图案项目", "https://www.behance.net/search/projects/?search=phone+case+illustration", "", 350),
    ("Behance · 茶具设计项目", "水杯", "新中式茶具产品设计项目", "https://www.behance.net/search/projects/?search=tea+set+design", "", 600),
    ("Behance · T恤图案设计", "T恤", "原创T恤图案印花设计项目", "https://www.behance.net/search/projects/?search=t-shirt+pattern+design", "", 400),
    ("Behance · 移动电源设计", "充电宝", "便携移动电源工业设计项目", "https://www.behance.net/search/projects/?search=power+bank+design", "", 400),
    ("Behance · 极简卡包设计", "卡包", "商务极简卡包产品设计项目", "https://www.behance.net/search/projects/?search=card+holder+design", "", 350),
    ("Behance · 环保水壶设计", "钥匙扣水壶", "可持续材料运动水壶设计", "https://www.behance.net/search/projects/?search=reusable+water+bottle+design", "", 350),
    ("Behance · 潮玩包装设计", "创意礼盒", "艺术潮玩盲盒包装设计项目", "https://www.behance.net/search/projects/?search=blind+box+packaging+design", "", 700),
    ("Behance · 礼盒包装系统", "创意礼盒", "高端礼盒包装结构设计项目", "https://www.behance.net/search/projects/?search=gift+box+packaging+design", "", 800),
    ("Behance · 中秋礼盒包装项目", "中秋礼盒", "新式中秋月饼礼盒包装设计", "https://www.behance.net/search/projects/?search=mooncake+packaging", "", 600),
    ("Behance · Polo衫品牌设计", "Polo衫", "美式复古Polo衫品牌视觉设计", "https://www.behance.net/search/projects/?search=polo+shirt+brand+design", "", 400),
    ("Behance · 家居品牌视觉", "创意厨具", "生活方式品牌视觉识别系统", "https://www.behance.net/search/projects/?search=kitchen+brand+identity", "", 500),
    ("Behance · 卫衣品牌视觉", "卫衣", "街头服饰品牌视觉设计项目", "https://www.behance.net/search/projects/?search=streetwear+brand+design", "", 500),
    ("Behance · 互动装置设计", "装置艺术", "互动式数字艺术装置项目", "https://www.behance.net/search/projects/?search=interactive+installation", "", 900),
    ("Behance · 咖啡器具包装", "水杯", "精品咖啡器具包装设计项目", "https://www.behance.net/search/projects/?search=coffee+packaging+design", "", 600),
    ("Behance · 桌面收纳系统设计", "创意桌搭", "模块化桌面收纳系统设计项目", "https://www.behance.net/search/projects/?search=desk+organizer+design", "", 400),
    ("Behance · 装置艺术项目", "装置艺术", "大型公共艺术装置设计项目", "https://www.behance.net/search/projects/?search=art+installation+design", "", 1200),
    ("Behance · 日历设计项目", "日历", "创意桌面日历视觉设计项目", "https://www.behance.net/search/projects/?search=calendar+design+2025", "", 500),
    ("Behance · 端午礼盒设计", "端午礼盒", "端午节龙舟主题礼盒包装", "https://www.behance.net/search/projects/?search=dragon+boat+festival+packaging", "", 450),
    ("Behance · 香氛包装设计", "氛围灯", "小众香氛品牌包装视觉项目", "https://www.behance.net/search/projects/?search=candle+packaging+design", "", 700),
    ("Behance · 潮流帽子包装", "帽子", "街头品牌棒球帽包装设计", "https://www.behance.net/search/projects/?search=hat+packaging+design", "", 350),
    ("Behance · 极简水壶设计", "水杯", "工业设计极简水壶项目", "https://www.behance.net/search/projects/?search=minimalist+water+bottle+design", "", 800),
]
...
def main():
    ...
    for title, cat, desc, url, image, likes, source in all_data:
        score_base = 8.0 if ("奖" in source or "Award" in source or source in ("Pinterest","Behance")) else 7.2

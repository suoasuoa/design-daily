...
- [本周 100 条选品推荐](https://suoasuoa.github.io/design-daily/insight/weekly.md)
...
insight/weekly.md        本周 100 条推荐周报
...
1. 每周先看 `insight/weekly.md` 的 100 条推荐。
2. 对感兴趣的内容进入原链接查看细节。
3. 按 `可直接买样 / 适合改造 / 方向参考` 决定下一步动作。
4. 人工筛选后再进入团队正式选品池。
